...
function  MakeImage({coordinates}) {
      const [imagemUrl, setImagemUrl] = useState("");
    // URL do servidor Flask
    const flaskUrl = `http://127.0.0.1:5000/imagem?param1=${coordinates.LatitudeMin}&param2=${coordinates.LatitudeMax}&param3=${coordinates.LongitudeMin}&param4=${coordinates.LongitudeMax}`;
